    ...
    const result = await prisma.$transaction(async (tx) => {
      ...
      const updatedAlumni = await tx.alumni.update({
        ...
        data: {
          ...
          ...(latitudeAsal !== undefined && { latitudeAsal: latitudeAsal ? parseFloat(latitudeAsal) : null }),
          ...(longitudeAsal !== undefined && { longitudeAsal: longitudeAsal ? parseFloat(longitudeAsal) : null }),
